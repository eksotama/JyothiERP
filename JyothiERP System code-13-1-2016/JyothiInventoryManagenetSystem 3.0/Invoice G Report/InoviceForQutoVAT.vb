...
Public Class InoviceForQutoVAT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JyothiPharmaERPSystem3.InoviceForQutoVAT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInoviceForQutoVAT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InoviceForQutoVAT = New InoviceForQutoVAT()
        rpt.Site = Me.Site
        Return rpt
    End Function
