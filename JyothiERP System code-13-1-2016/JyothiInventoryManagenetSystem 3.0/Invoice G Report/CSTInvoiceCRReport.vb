...
Public Class CSTInvoiceCRReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JyothiPharmaERPSystem3.CSTInvoiceCRReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCSTInvoiceCRReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CSTInvoiceCRReport = New CSTInvoiceCRReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
