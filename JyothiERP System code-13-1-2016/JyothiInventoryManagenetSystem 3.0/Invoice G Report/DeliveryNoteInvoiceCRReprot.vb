...
Public Class DeliveryNoteInvoiceCRReprot
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "DeliveryNoteInvoiceCRReprot.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JyothiPharmaERPSystem3.DeliveryNoteInvoiceCRReprot.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDeliveryNoteInvoiceCRReprot
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DeliveryNoteInvoiceCRReprot = New DeliveryNoteInvoiceCRReprot()
        rpt.Site = Me.Site
        Return rpt
    End Function
