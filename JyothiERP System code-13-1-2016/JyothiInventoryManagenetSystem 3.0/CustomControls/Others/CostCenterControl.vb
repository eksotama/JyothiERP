Public Class CostCenterControl
    ...
    Private Sub CostCenterControl_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If CtrlNo = 0 Then
            LoadDataIntoCostCenterComboBox("SELECT StockGroupName as Nv FROM CostCenters ", TxtCostCatName, "NV")
        Else
            LoadDataIntoCostCenterComboBox("SELECT StockGroupName as Nv FROM CostCenters ", TxtCostCatName, "NV", "*End Of List")
        End If
