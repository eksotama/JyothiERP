...
Public Class ViewDocFilesfrm
    ...
    Sub LoadDocDatas()
        ...
        Try
            ...
            SqlFcmd.CommandText = "select * from documents where docname=N'" & TxtDocName.Text & "'"
    ...
    Private Sub ViewDocFilesfrm_Activated(sender As Object, e As System.EventArgs) Handles Me.Shown
        ERPInitializeObjects(Me)
    End Sub

    Private Sub ViewDocFilesfrm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        LoadDataIntoComboBox("select docname from documents", TxtDocName, "docname")
