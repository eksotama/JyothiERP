...
Public Class RollPaperPrintingSettingsForm
    ...
    Private Sub RollPaperPrintingSettingsForm_Activated(sender As Object, e As System.EventArgs) Handles Me.Shown
    ...
    Sub LoadSchemesIntoBoxes()
        LoadDataIntoComboBox("select  schemename from printingsettings where IsrollPaper='True'", txtSchemName, "schemename")
    ...
    Sub LoadDefauls()
        ...
        Try
            ...
            While Sreader.Read()
                ...
                ' SqlStr = SqlStr & "height=" & TxtRFHeight.TextAlign & ","
                ' SqlStr = SqlStr & "pagenoleft=" & TxtHeaderHeight.Text & ","
                '        SqlStr = SqlStr & "pagenotop=" & TxtFooterHeight.Text & ","
                ...
                TxtHeaderHeight.Text = Sreader("pagenoleft")
                TxtFooterHeight.Text = Sreader("pagenotop")
    ...
    Private Sub txtrightedge_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles txtrightedge.Validating, txtrightwidth.Validating, txtrighttop.Validating, txtrightheight.Validating, TxtPaperWidth.Validating, txtleftwidth.Validating, txtlefttop.Validating, txtleftheight.Validating, txtleftEdge.Validating, TxtFooterHeight.Validating, TxtHeaderHeight.Validating
    ...
    Private Sub PrtDoc_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrtDoc.BeginPrint
        If TxtFullView.Checked = True Then
            RollPaperBeginPrint(sender, 0, "PrintingDataRowsItems", "PrintDataDetails", txtSchemName.Text, 0)
        Else
            RollPaperBeginPrint(sender, 0, "PrintingDataRowsItems", "PrintDataDetails", txtSchemName.Text, 1)
        End If
    ...
    Private Sub PrtDoc_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrtDoc.PrintPage
        If txtSchemName.Text.Length = 0 Then
            Exit Sub
        End If
        RollPaperPrinting(sender, e, PrtDoc, TxtFullView.Checked)
    End Sub
    ...
    Private Sub BtnPagesetupSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnPagesetupSave.Click
        ...
        If MsgBox("Do You want to save?           ", MsgBoxStyle.YesNo + MsgBoxStyle.Information) = MsgBoxResult.Yes Then
            ...
            SqlStr = SqlStr & "height=" & TxtRFHeight.Value & ","
            ...
            SqlStr = SqlStr & "pagenoleft=" & TxtHeaderHeight.Text & ","
            SqlStr = SqlStr & "pagenotop=" & TxtFooterHeight.Text & ","
            SqlStr = SqlStr & "pageformat=1  where schemename=N'" & txtSchemName.Text & "'"
            'MsgBox SqlStr 
    ...
    Private Sub btnRecordSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRecordSave.Click
        ...
        End If
        '
        If TxtSuppres.Text.Length = 0 Or TxtSuppres.Text = "NO" Then
            ...
            'SqlStr = SqlStr & "align=N'" & TxtFLFAlign.Text & "',decimals=" & TxtFDecimals.Value & ",supress=0  where schemename=N'" & txtSchemName.Text & "' and fieldname=N'" & TxtFieldLables.Text & "'"
        Else
        ...
        If frm.ShowDialog() = vbOK Then
            ...
            Try
                ...
                While Sreader.Read()
                    ...
                    ',[IsLedgerValue] ,[decimals] ,[supress]
            ...
            Try
                ...
                While Sreader.Read()
                    ...
                    Line = Line & Sreader("pageformat") & ",'" & Sreader("IsrollPaper") & "'"
...
XX:         SchName = InputBox("Please Enter the New Scheme Name ", "Scheme Name", "")
    ...
    Private Sub Button5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button5.Click
        ...
        ExecuteSQLQuery("UPDATE printingsettings SET printername='" & TxtPrinterName.Text & "'")
    End Sub

    Private Sub TxtFullView_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtFullView.CheckedChanged
        LoadReport()
    End Sub

    Private Sub cmbAutoPreview_CheckedChanged(sender As System.Object, e As System.EventArgs) Handles cmbAutoPreview.CheckedChanged
