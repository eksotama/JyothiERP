...
Public Class Barcode39CRReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JyothiPharmaERPSystem3.Barcode39CRReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBarcode39CRReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Barcode39CRReport = New Barcode39CRReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
