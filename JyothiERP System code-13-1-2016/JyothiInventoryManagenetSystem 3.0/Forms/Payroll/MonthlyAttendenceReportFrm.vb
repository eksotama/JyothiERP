Public Class MonthlyAttendenceReportFrm

    Private Sub MonthlyAttendenceReportFrm_Activated(sender As Object, e As System.EventArgs) Handles Me.Shown
            ...
            Else
                ...
                ElseIf SQLIsFieldExists("SELECT empname FROM EmpAttend where empname=N'" & TxtEmployeeName.Text & "' and Transdatevalue=" & tdp.Value.Date.ToOADate) = True Then
                    ...
                    ElseIf totvalue = 0.5 Then
                        ...
                        totala = totala + 1 / 2
                    End If
                    'totvalue = SQLGetNumericFieldValue("SELECT COUNT(*) AS TOT FROM EmpAttend where empname=N'" & TxtEmployeeName.Text & "' and Transdatevalue=" & tdp.Value.Date.ToOADate, "TOT")
                    'If totvalue = 2 Then
                    '    totalp = totalp + 1
                    'ElseIf totvalue = 1 Then
                    '    If SQLIsFieldExists("SELECT empname FROM EmpAttend where period='M' and  empname=N'" & TxtEmployeeName.Text & "' and Transdatevalue=" & tdp.Value.Date.ToOADate) = True Then
                    '        totalp = totalp + 1 / 2
                    '        totala = totala + 1 / 2
                    '    ElseIf SQLIsFieldExists("SELECT empname FROM EmpAttend where  period='E' and empname=N'" & TxtEmployeeName.Text & "' and Transdatevalue=" & tdp.Value.Date.ToOADate) = True Then
                    '        totalp = totalp + 1 / 2
                    '        totala = totala + 1 / 2
                    '    End If
                    'End If
