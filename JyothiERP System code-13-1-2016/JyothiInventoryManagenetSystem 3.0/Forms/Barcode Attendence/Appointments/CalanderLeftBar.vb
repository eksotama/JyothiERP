Public Class CalanderLeftBar
    ...
    Public ShowEmployeeImages As Boolean = False
    ...
    Public Property TimeScaleValues() As Integer
        ...
        Set(value As Integer)
            TimeUnits = value
            Me.Height = TimeScaleRowHeight * TimeUnits * 24 + 60
        ...
        If VerticalEmpDisply = True Then
            ...
            If EmployeeList.Items.Count > 0 Then
                For i As Integer = 1 To EmployeeList.Items.Count
                    Dim rect1 As New Rectangle(0, Kheight, 120, 80)
                    'e.Graphics.DrawLine(Pens.Blue, CalanderColumnWidth * i + LeftGap, 0, CalanderColumnWidth * i + LeftGap, Me.Width)
                    e.Graphics.DrawString(EmployeeList.Items(i - 1).ToString, New Font("Arial", 10, FontStyle.Bold), Brushes.Green, rect1, sf)
                    Kheight = Kheight + 35
                    'If ShowEmployeeImages = True Then
        ...
        Else
            ...
            If ShowOnlyStartEndTimeScale = False Then
                ...
                For i As Integer = 1 To (24 * TimeUnits) + 1
                    ...
                    If (i Mod TimeUnits) = 0 Then
                        e.Graphics.DrawLine(Pens.Red, LeftGap, CalanderColumnWidth * (i + 1), Me.Width, CalanderColumnWidth * (i + 1))
                    ...
                    Else
                        e.Graphics.DrawLine(Pens.LightBlue, LeftGap + 10, CalanderColumnWidth * (i + 1), Me.Width, CalanderColumnWidth * (i + 1))
            ...
            Else
                ...
                For i As Integer = 1 To totalmin / countval + 1
                    ...
                    End If
                Next
                Me.Height = DateDiff(DateInterval.Minute, StartTime, EndTime) / countval * TimeScaleRowHeight + 90
            End If
        End If
        ' e.Graphics.DrawLine(HeadPen, TimeScaleRowHeight, TopGap, Me.Width, TimeScaleRowHeight)
