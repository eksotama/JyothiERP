...
Public Class multiPurchaseInvoices
    ...
    Sub Loadreport()
        ...
        End If
        Dim Vhstr As String = ""
        If TxtVoucherType.Text = "All Purchase" Then
            Vhstr = " ('PG','DP') "
            pvalues.VouhcerName = PrintVoucherNames.purchaseinvoice
        ElseIf TxtVoucherType.Text = "Goods Receipt" Then
            Vhstr = " ('PG') "
            pvalues.VouhcerName = PrintVoucherNames.purchasegoods

        ElseIf TxtVoucherType.Text = "Purchase Invoice" Then
            Vhstr = " ('DP', 'PI') "
            pvalues.VouhcerName = PrintVoucherNames.purchaseinvoice
        ElseIf TxtVoucherType.Text = "Purchase Orders" Then
            Vhstr = " ('PO') "
            pvalues.VouhcerName = PrintVoucherNames.purchaseorder
        ElseIf TxtVoucherType.Text = "Debit Notes" Then
            Vhstr = " ('PR') "
    ...
    Private Sub multiPurchaseInvoices_Activated(sender As Object, e As System.EventArgs) Handles Me.Shown
