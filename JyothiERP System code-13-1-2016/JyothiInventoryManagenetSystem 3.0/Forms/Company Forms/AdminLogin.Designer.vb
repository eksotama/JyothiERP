...
Partial Class AdminLogin
    ...
    '20160418changesstart
    Protected Overrides ReadOnly Property CreateParams() As CreateParams
        Get
            Dim createParams__1 As CreateParams = MyBase.CreateParams
            Dim parent As Form = Me.FindForm()
            Dim parentRightToLeftLayout As Boolean = If(parent IsNot Nothing, parent.RightToLeftLayout, False)
            If (Me.RightToLeft = RightToLeft.Yes) AndAlso parentRightToLeftLayout Then
                createParams__1.ExStyle = createParams__1.ExStyle Or &H500000
                ' WS_EX_LAYOUTRTL | WS_EX_NOINHERITLAYOUT
                ' WS_EX_RIGHT | WS_EX_RTLREADING | WS_EX_LEFTSCROLLBAR
                createParams__1.ExStyle = createParams__1.ExStyle And Not &H7000
            End If
    ...
    Private Sub InitializeComponent()
        ...
        Me.OK.Name = "OK"
        Me.OK.RightToLeft = System.Windows.Forms.RightToLeft.Yes
        ...
        Me.Cancel.RightToLeft = System.Windows.Forms.RightToLeft.Yes
        ...
        Me.TxtCmpName.RightToLeft = System.Windows.Forms.RightToLeft.Yes
