...
Public Class ClientMasterCRReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ClientMasterCRReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JyothiPharmaERPSystem3.ClientMasterCRReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedClientMasterCRReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ClientMasterCRReport = New ClientMasterCRReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
