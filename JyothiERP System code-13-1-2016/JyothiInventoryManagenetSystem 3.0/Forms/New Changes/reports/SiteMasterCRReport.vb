...
Public Class SiteMasterCRReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JyothiPharmaERPSystem3.SiteMasterCRReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSiteMasterCRReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SiteMasterCRReport = New SiteMasterCRReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
