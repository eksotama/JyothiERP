...
Public Class StockMovenentDetailedCRReport_Out
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "StockMovenentDetailedCRReport-Out.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JyothiPharmaERPSystem3.StockMovenentDetailedCRReport-Out.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStockMovenentDetailedCRReport_Out
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StockMovenentDetailedCRReport_Out = New StockMovenentDetailedCRReport_Out()
        rpt.Site = Me.Site
        Return rpt
    End Function
