...
Public Class StockSummeryCRReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "StockSummeryCRReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JyothiPharmaERPSystem3.StockSummeryCRReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStockSummeryCRReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StockSummeryCRReport = New StockSummeryCRReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
