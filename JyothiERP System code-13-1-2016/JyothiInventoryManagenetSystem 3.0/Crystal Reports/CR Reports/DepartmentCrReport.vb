...
Public Class DepartmentCrReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JyothiPharmaERPSystem3.DepartmentCrReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDepartmentCrReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DepartmentCrReport = New DepartmentCrReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
