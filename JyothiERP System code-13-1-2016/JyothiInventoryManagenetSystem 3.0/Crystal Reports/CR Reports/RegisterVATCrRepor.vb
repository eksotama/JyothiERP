...
Public Class RegisterVATCrRepor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JyothiPharmaERPSystem3.RegisterVATCrRepor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRegisterVATCrRepor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RegisterVATCrRepor = New RegisterVATCrRepor()
        rpt.Site = Me.Site
        Return rpt
    End Function
