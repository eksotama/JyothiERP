...
Public Class LedgerAddressList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JyothiPharmaERPSystem3.LedgerAddressList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLedgerAddressList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LedgerAddressList = New LedgerAddressList()
        rpt.Site = Me.Site
        Return rpt
    End Function
