...
Public Class ExpiryStockCRReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ExpiryStockCRReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JyothiPharmaERPSystem3.ExpiryStockCRReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedExpiryStockCRReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ExpiryStockCRReport = New ExpiryStockCRReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
