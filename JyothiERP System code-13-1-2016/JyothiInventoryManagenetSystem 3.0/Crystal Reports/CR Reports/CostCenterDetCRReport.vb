...
Public Class CostCenterDetCRReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CostCenterDetCRReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JyothiPharmaERPSystem3.CostCenterDetCRReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCostCenterDetCRReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CostCenterDetCRReport = New CostCenterDetCRReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
