...
Public Class NotesCRPrint
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JyothiPharmaERPSystem3.NotesCRPrint.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNotesCRPrint
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NotesCRPrint = New NotesCRPrint()
        rpt.Site = Me.Site
        Return rpt
    End Function
