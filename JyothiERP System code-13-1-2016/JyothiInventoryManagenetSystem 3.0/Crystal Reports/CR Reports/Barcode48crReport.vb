...
Public Class Barcode48crReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JyothiPharmaERPSystem3.Barcode48crReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBarcode48crReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Barcode48crReport = New Barcode48crReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
