...
Public Class LeaveTblCRReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JyothiPharmaERPSystem3.LeaveTblCRReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLeaveTblCRReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LeaveTblCRReport = New LeaveTblCRReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
