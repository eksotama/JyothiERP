...
Public Class UserCrReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JyothiPharmaERPSystem3.UserCrReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedUserCrReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As UserCrReport = New UserCrReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
