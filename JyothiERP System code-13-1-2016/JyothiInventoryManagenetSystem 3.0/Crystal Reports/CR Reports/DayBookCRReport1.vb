...
Public Class DayBookCRReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JyothiPharmaERPSystem3.DayBookCRReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDayBookCRReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DayBookCRReport = New DayBookCRReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
