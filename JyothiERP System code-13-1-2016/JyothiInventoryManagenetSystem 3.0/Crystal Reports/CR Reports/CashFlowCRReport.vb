...
Public Class CashFlowCRReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JyothiPharmaERPSystem3.CashFlowCRReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCashFlowCRReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CashFlowCRReport = New CashFlowCRReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
