...
Public Class VATPurchaseRegister
    ...
    Sub LoadReport()
        ...
        If IsLedgerCurrency.Checked = True Then
            SqlStr = "select  QutoNo as [Invoice No],QutoRef as [Ref No],TransDate as [Date], LedgerName as [Supplier Name], grosstotal*CurrencyCon1 as [Gross],Additions*CurrencyCon1 as [Additions],Deductions*CurrencyCon1 as [Deductions], (Currency + ' ' + CONVERT(varchar(30), CAST (nettotal*CurrencyCon1 AS DECIMAL(15,3)),1))  as [Net Total],(Currency + ' ' + CONVERT(varchar(30), CAST (taxtotal*CurrencyCon1 AS DECIMAL(15,3)),1))  as [Tax Amount],TransCode as [Trans Code] from StockInvoiceDetails where (VoucherName IN ('PI','DP')) and isdelete=0 "
        Else
            SqlStr = "select  QutoNo as [Invoice No],QutoRef as [Ref No],TransDate as [Date], LedgerName as [Supplier Name], grosstotal as [Gross],Additions as [Additions],Deductions as [Deductions], CONVERT(varchar(30), CAST (nettotal AS DECIMAL(15,3)),1)  as [Net Total],CONVERT(varchar(30), CAST (taxtotal AS DECIMAL(15,3)),1)  as [Tax Amount],TransCode as [Trans Code] from StockInvoiceDetails where (VoucherName IN ('PI','DP')) and isdelete=0  "
        End If
    ...
    Private Sub VATPurchaseRegister_Activated(sender As Object, e As System.EventArgs) Handles Me.Shown
    ...
    Private Sub BtnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnPrint.Click, PrintToolStripMenuItem.Click
        ...
        If TxtShowItemDetails.Checked = True Then
            ...
            cnn.Close()
            Dim objRpt As New RegisterSumVATCrReport
        ...
        Else
            ...
            cnn.Close()
            Dim objRpt As New RegisterVATCrRepor
