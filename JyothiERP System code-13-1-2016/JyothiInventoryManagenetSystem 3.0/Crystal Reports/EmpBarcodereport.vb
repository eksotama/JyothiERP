...
Public Class EmpBarcodereport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JyothiPharmaERPSystem3.EmpBarcodereport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEmpBarcodereport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EmpBarcodereport = New EmpBarcodereport()
        rpt.Site = Me.Site
        Return rpt
    End Function
