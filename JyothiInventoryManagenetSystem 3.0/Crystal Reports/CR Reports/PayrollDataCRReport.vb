...
Public Class PayrollDataCRReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PayrollDataCRReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JyothiPharmaERPSystem3.PayrollDataCRReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPayrollDataCRReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PayrollDataCRReport = New PayrollDataCRReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
