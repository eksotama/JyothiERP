...
Public Class MontlyLedgerCRReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "MontlyLedgerCRReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JyothiPharmaERPSystem3.MontlyLedgerCRReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMontlyLedgerCRReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MontlyLedgerCRReport = New MontlyLedgerCRReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
