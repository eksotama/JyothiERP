...
Public Class DaybookSubReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JyothiPharmaERPSystem3.DaybookSubReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDaybookSubReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DaybookSubReport = New DaybookSubReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
