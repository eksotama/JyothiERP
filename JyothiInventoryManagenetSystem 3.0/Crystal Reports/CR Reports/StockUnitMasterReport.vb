...
Public Class StockUnitMasterReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "StockUnitMasterReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JyothiPharmaERPSystem3.StockUnitMasterReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStockUnitMasterReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StockUnitMasterReport = New StockUnitMasterReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
