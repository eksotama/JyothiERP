...
Public Class DocIssuedCrReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JyothiPharmaERPSystem3.DocIssuedCrReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDocIssuedCrReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DocIssuedCrReport = New DocIssuedCrReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
