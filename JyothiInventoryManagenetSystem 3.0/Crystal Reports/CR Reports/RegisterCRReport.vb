...
Public Class RegisterCRReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JyothiPharmaERPSystem3.RegisterCRReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRegisterCRReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RegisterCRReport = New RegisterCRReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
