...
Public Class AccountsCRReportM
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JyothiPharmaERPSystem3.AccountsCRReportM.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAccountsCRReportM
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AccountsCRReportM = New AccountsCRReportM()
        rpt.Site = Me.Site
        Return rpt
    End Function
