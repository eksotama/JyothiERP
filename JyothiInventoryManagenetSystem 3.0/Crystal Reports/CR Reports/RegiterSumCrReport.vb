...
Public Class RegiterSumCrReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JyothiPharmaERPSystem3.RegiterSumCrReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRegiterSumCrReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RegiterSumCrReport = New RegiterSumCrReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
