...
Public Class OverDueCRReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JyothiPharmaERPSystem3.OverDueCRReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOverDueCRReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OverDueCRReport = New OverDueCRReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
