...
Public Class LedgerReportsCRReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "LedgerReportsCRReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JyothiInventoryManagenetSystem_3._0.LedgerReportsCRReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLedgerReportsCRReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LedgerReportsCRReport = New LedgerReportsCRReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
