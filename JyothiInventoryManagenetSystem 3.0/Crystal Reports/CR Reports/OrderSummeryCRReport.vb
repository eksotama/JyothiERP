...
Public Class OrderSummeryCRReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "OrderSummeryCRReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JyothiPharmaERPSystem3.OrderSummeryCRReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOrderSummeryCRReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OrderSummeryCRReport = New OrderSummeryCRReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
