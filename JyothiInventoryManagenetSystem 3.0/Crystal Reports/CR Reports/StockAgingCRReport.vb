...
Public Class StockAgingCRReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JyothiPharmaERPSystem3.StockAgingCRReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStockAgingCRReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StockAgingCRReport = New StockAgingCRReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
