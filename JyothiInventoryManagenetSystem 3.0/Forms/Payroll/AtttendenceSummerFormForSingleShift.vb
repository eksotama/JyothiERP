Public Class AtttendenceSummerFormForSingleShift
    Sub LoadMonthlyData(ByVal tdate As DateTimePicker)
        ...
        For emprowno As Integer = 0 To Employeeslist.Items.Count - 1
            ...
            otvalue = SQLGetNumericFieldValue("select sum(ot) as tot from EmpAttend where  empname=N'" & Employeeslist.Items(emprowno).ToString & "' and ( Transdatevalue between " & startdate.Value.Date.ToOADate & " and " & enddate.Value.Date.ToOADate & ")", "tot")
    ...
    Private Sub AtttendenceSummerFormForSingleShift_Activated(sender As Object, e As System.EventArgs) Handles Me.Shown
