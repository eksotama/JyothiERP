Public Class EmployeeAttendenceSheet
    ...
    Private Sub ImsButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ImsButton1.Click, CloseToolStripMenuItem.Click, ImsButton4.Click
        Me.Close()
    End Sub

    Private Sub BtnLeaves_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnLeaves.Click, GrantToolStripMenuItem1.Click, ImsButton7.Click
        Dim k As New GrantLeave
        k.ShowDialog()
        LoadData()
    End Sub

    Private Sub ImsButton2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ImsButton2.Click, PrintToolStripMenuItem.Click, ImsButton5.Click

    End Sub

    Private Sub ImsButton3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ImsButton3.Click, ReloadToolStripMenuItem.Click, ImsButton6.Click
        LoadData()
    End Sub
