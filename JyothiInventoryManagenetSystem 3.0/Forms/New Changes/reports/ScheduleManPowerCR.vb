...
Public Class ScheduleManPowerCR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JyothiPharmaERPSystem3.ScheduleManPowerCR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedScheduleManPowerCR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ScheduleManPowerCR = New ScheduleManPowerCR()
        rpt.Site = Me.Site
        Return rpt
    End Function
