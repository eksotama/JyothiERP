...
Public Class StockTransferFrm
    ...
    Dim IsInterBranchTransfer As Boolean = False
    Sub New(Optional IBTransfer As Boolean = False)

        ' This call is required by the designer.
        InitializeComponent()
        IsInterBranchTransfer = IBTransfer
    ...
    Sub LoadDefaults()
        ...
        End If
        If IsInterBranchTransfer = True Then
            TableLayoutPanel2.ColumnStyles.Item(7).Width = 0
    ...
    Sub CheckBeforeSave()
        ...
        If MsgBox("Do you want to save ?", MsgBoxStyle.Information + MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
            SaveData()
            If Pulledtranscode > 0 Then
                ExecuteSQLQuery("Update StockTransferDetails set IsPending=0  where transcode=" & Pulledtranscode)
            End If
        End If
    End Sub
    Sub SaveData()
    ...
    Private Sub TxtLocationTo_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles TxtLocationTo.SelectedIndexChanged
