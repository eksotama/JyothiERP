Public Class AssetmanagmentFrm
...
#Region "Functions"
    Sub LoadSuppliersList(Optional ByVal sqlText As String = "")
        ...
        Sqlstr = "SELECT LedgerCode as [Code], LedgerName as [Supplier Name],AccountGroup as [Account Type],address as [Location],state as [State],Tel as [Contact Number],fax as [Fax Number],emailid as [Email  ID],f1 as [Balance] from ledgers where (Accountgroup in (select subgroup from AccountGroupsList where groupname=N'" & AccountGroupNames.SuppliersAccounts & "'))"
...
#End Region
    ...
    Private Sub AssetmanagmentFrm_Activated(sender As Object, e As System.EventArgs) Handles Me.Shown
