Public Class AdvDashBoardfrm
    ...
    Private Sub TXTPURCHASE_CellDoubleClick(sender As Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles TXTPURCHASE.CellDoubleClick
        ...
        If VoucherNameValue = "PurchaseInvoice" Or VoucherNameValue = "DP" Then
            Dim frm As New InvoiceAlterForm
    ...
    Sub loadEMPIDdata()
        ...
        Me.TxtEmpIDList.Columns(1).Width = 55
    ...
    End Sub
    Private Sub TxtempidList_CellPainting(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellPaintingEventArgs) Handles TxtEmpIDList.CellPainting
    ...
    Sub loadvhiddata()
        ...
        Me.TxtVhIDList.Columns(1).Width = 50
        Me.TxtVhIDList.Columns(2).AutoSizeMode = DataGridViewAutoSizeColumnMode.None
        Me.TxtVhIDList.Columns(2).Width = 120

    End Sub
    Private Sub TxtvhidList_CellPainting(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellPaintingEventArgs) Handles TxtVhIDList.CellPainting
        Dim expDate As New Date
        Dim Days As Integer = 0
