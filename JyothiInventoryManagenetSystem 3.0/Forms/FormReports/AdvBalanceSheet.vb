Public Class AdvBalanceSheet
    ...
    Sub loaddata()
        ...
        If IsDateWiseOn.Checked = True Then
            val = SQLGetNumericFieldValue("select sum(dr-CR) as tot from ledgerbook where isdeleted=0 " & AdditionalWhereSQLStr & "  and ledgername in " & SqlStr & "  and (Transdatevalue between " & (CDbl(TxtStartDate.Value.Date.ToOADate)) & " and " & (CDbl(TxtEndDate.Value.Date.ToOADate)) & ")", "tot")
        Else
            val = SQLGetNumericFieldValue("select sum(dr-CR) as tot from ledgerbook where isdeleted=0  " & AdditionalWhereSQLStr & "   and ledgername in " & SqlStr, "tot")
        End If
            ...
            For i As Integer = 0 To cmbGroups.Items.Count - 1
                ...
                If IsSubDetails.Checked = True Then
                    ...
                    Try
                        ...
                        Sqlcmmd.Connection = SqlConn
                        If IsDateWiseOn.Checked = True Then
                            Sqlcmmd.CommandText = "select LEDGERNAME, sum(dr-cr) as tot from ledgerbook where isdeleted=0   " & AdditionalWhereSQLStr & "  and ledgername in " & SqlStr & "  and (Transdatevalue between " & (CDbl(TxtStartDate.Value.Date.ToOADate)) & " and " & (CDbl(TxtEndDate.Value.Date.ToOADate)) & ") GROUP BY LEDGERNAME"
                        Else
                            Sqlcmmd.CommandText = "select LEDGERNAME, sum(dr-cr) as tot from ledgerbook where isdeleted=0   " & AdditionalWhereSQLStr & "  and ledgername in " & SqlStr & " GROUP BY LEDGERNAME"
                        End If
        ...
        If ShowCaptialAccountsalso = True Then
            ...
            If IsDateWiseOn.Checked = True Then
                val = SQLGetNumericFieldValue("select sum(Cr-DR) as tot from ledgerbook where isdeleted=0  " & AdditionalWhereSQLStr & "   and ledgername in " & SqlStr & "  and (Transdatevalue between " & (CDbl(TxtStartDate.Value.Date.ToOADate)) & " and " & (CDbl(TxtEndDate.Value.Date.ToOADate)) & ")", "tot")
            Else
                val = SQLGetNumericFieldValue("select sum(Cr-DR) as tot from ledgerbook where isdeleted=0   " & AdditionalWhereSQLStr & "  and ledgername in " & SqlStr, "tot")
            End If
                ...
                For i As Integer = 0 To cmbGroups.Items.Count - 1
                    ...
                    If IsSubDetails.Checked = True Then
                        ...
                        Try
                            ...
                            Sqlcmmd.Connection = SqlConn
                            If IsDateWiseOn.Checked = True Then
                                Sqlcmmd.CommandText = "select LEDGERNAME, sum(cr-dr) as tot from ledgerbook where isdeleted=0  " & AdditionalWhereSQLStr & "   and ledgername in " & SqlStr & "  and (Transdatevalue between " & (CDbl(TxtStartDate.Value.Date.ToOADate)) & " and " & (CDbl(TxtEndDate.Value.Date.ToOADate)) & ") GROUP BY LEDGERNAME"
                            Else
                                Sqlcmmd.CommandText = "select LEDGERNAME, sum(cr-dr) as tot from ledgerbook where isdeleted=0  " & AdditionalWhereSQLStr & "   and ledgername in " & SqlStr & " GROUP BY LEDGERNAME"
                            End If
    ...
    Private Sub AdvBalanceSheet_Activated(sender As Object, e As System.EventArgs) Handles Me.Shown
