...
Public Class CouponMasterCRReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CouponMasterCRReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JyothiPharmaERPSystem3.CouponMasterCRReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCouponMasterCRReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CouponMasterCRReport = New CouponMasterCRReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
